    ...
    return html.Div(
        ...
        children=[
            html.Div(
                id="banner-text",
                children=[
                    html.H5("Manufature dataset"),
                    html.H6("Product Line with specifications"),
                ],
            ),
            html.Div(
                id="banner-logo",
            ...
            html.Div(
                ...
                children=[
                    ...
                    html.Div(
                        ...
                        Click on buttons in `
                        ` column to visualize details of measurement trendlines on the bottom panel.
...
@app.callback(
    output=Output("operator-led", "value"),
